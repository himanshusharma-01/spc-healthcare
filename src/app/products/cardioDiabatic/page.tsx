...
export default function CardioDiabeticPage() {
  ...
  const subcategories = useMemo(() => {
    return extractSubcategories(allProducts, 'cardiodiabetic');
  }, [allProducts]);
  ...
  const filteredProducts = useMemo(() => {
    ...
    if (activeSubcategory !== 'all') {
      filtered = filterProductsBySubcategory(filtered, 'cardiodiabetic', activeSubcategory);
    }
            ...
            <div className="products-filter-container">
              <div className="filter-tabs">
                {subcategories.map(subcategory => {
                  const count = filterProductsBySubcategory(allProducts, 'cardiodiabetic', subcategory.id).length;
                  return (
                    <button
                      key={subcategory.id}
