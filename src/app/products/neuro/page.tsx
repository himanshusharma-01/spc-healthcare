...
export default function NeuroPage() {
  ...
  const subcategories = useMemo(() => {
    return extractSubcategories(allProducts, 'neuro');
  }, [allProducts]);
  ...
  const filteredProducts = useMemo(() => {
    ...
    if (activeSubcategory !== 'all') {
      filtered = filterProductsBySubcategory(filtered, 'neuro', activeSubcategory);
    }
  ...
  useEffect(() => {
    const loadProducts = async () => {
      try {
        setLoading(true);
        const neuroProducts = await loadCategoryProducts('neuro');
        setAllProducts(neuroProducts);
      } catch (error) {
        console.error('Error loading neuro products:', error);
        setAllProducts([]);
      } finally {
        setLoading(false);
      }
  ...
  return (
    <div className="l3-container neuro-page">
      {/* Hero Section */}
      <section className="neuro-hero" aria-label="Neuro hero banner">
        <div className="neuro-hero-background" role="presentation"></div>
      </section>
      ...
      <section className="products-section">
        <div className="l3-container-inner">
          <div className="section-header">
            <h2 className="l3-section-title">Our Neuro Products</h2>
            <p className="l3-section-subtitle">
              Discover our range of high-quality neurological formulations.
            </p>
          </div>
          ...
          <div className="category-search-container">
            <div className="category-search-box">
              ...
              <input
                type="text"
                placeholder="Search neuro products by name, description, or usage..."
